...
For each test case, the first line contains N (2≤N≤10000), the total number of computers in a network. 
...
At the end of each case, print in one line "The network is connected." if there is a path between any pair of computers; 
...
yes
yes
>>>>>>> 2cd6b87261a5fc985a27974990977db09adebd59
