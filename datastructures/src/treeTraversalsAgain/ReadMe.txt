...
For each case, the first line contains a positive integer N (N≤30) which is the total number of nodes in a tree (and hence the nodes are numbered from 1 to N).
